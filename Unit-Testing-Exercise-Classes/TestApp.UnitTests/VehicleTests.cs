...
public class VehicleTests
{
    ...
    public void Test_AddAndGetCatalogue_ReturnsSortedCatalogue()
    {
        ...
        string expected = $"Cars:{Environment.NewLine}Ford: Focus - 120hp{Environment.NewLine}Toyota: Camry - 150hp" +
            $"{Environment.NewLine}Trucks:{Environment.NewLine}Volvo: VNL - 500kg";
